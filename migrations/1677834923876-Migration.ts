...
export class Migration1677834923876 implements MigrationInterface {
  name = 'Migration1677834923876';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE \`products\` (\`id\` varchar(36) NOT NULL, \`createdAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` timestamp(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`availableSizes\` json NOT NULL, \`currencyFormat\` varchar(1) NOT NULL, \`currencyId\` varchar(255) NOT NULL, \`description\` varchar(255) NOT NULL, \`installments\` int NOT NULL, \`isFreeShipping\` tinyint NOT NULL, \`price\` float NOT NULL, \`style\` varchar(255) NOT NULL, \`title\` varchar(255) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
